...
{{-- Content --}}
    <div class="card">
        <h5 class="card-header" style="text-align: center;"><strong> Product</strong>
            ...
            <a href="product-add" class="btn btn-primary" style="float:right;">Tambah</a>
        </h5>
          ...
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td><strong>{{$item->original_price}}</strong></td>
                <td><strong>{{$item->sell_price}}</strong></td>
                <td>
                    <img src="{{ asset('assets/upload/product/'.$item->image)}}" class="cate-image" alt="" >
                    {{-- <span class="badge {{($item->status_id ==1)? 'bg-label-primary me-1': 'bg-label-danger me-1'}}">{{($item->status_id == 1)? 'Complated' : 'Pending'}}</span> --}}
                </td>
                <td>
                      <a class="btn btn-primary"  href="product-show{{$item->id}}">Edit</a>
                      <a class="btn btn-danger" style="font-size: 12px;" href="product-delete{{$item->id}}"><i class="bx bx-trash me-1"></i> Delete</a>
                    </div>
                  </div>
                </td>
              </tr>
