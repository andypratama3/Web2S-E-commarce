...
{{-- Content --}}
    <div class="card">
        <h5 class="card-header" style="text-align: center;"><strong>Orders History</strong>
            <a href="/orders"><button type="button"
                    class="btn btn-info"
                    style="float: left">
                Kembali
            </button>
            ...
            <a href="{{url('orders')}}" class="btn btn-warning" style="float:right;">New Order</a>
        </h5>
