        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="/Dashboard" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Bor Data</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ request()->is('category','add-category') ? 'active' : '' }}">
              <a href="/category" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div>Category</div>
              </a>
            </li>
            <li class="menu-item {{ request()->is('product','product-add') ? 'active' : '' }}">
            ...
            <li class="menu-item {{ request()->is('users') ? 'active' : '' }}">
              <a href="/users" class="menu-link">
                ...
                <div data-i18n="Basic">All User</div>
              </a>
            </li>
            <!-- User interface -->
            <li class="menu-item {{ request()->is('orders') ? 'active' : '' }}">
              <a href="/orders" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="User interface">New Orders</div>
              </a>
            </li>
            <li class="menu-item {{ request()->is('Dashboard/FeedBack') ? 'active' : '' }}">
                <a href="/Dashboard/FeedBack" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-data"></i>
                  <div data-i18n="User interface">Feed Back</div>
                </a>
              </li>
                  ...
                  <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                      <div class="avatar avatar-online">
                        <img src="{!!asset('assetsMaster/img/avatars/1.png')!!}" alt class="w-px-40 h-auto rounded-circle" />
                      </div>
                    </a>
                        ...
                        <a class="dropdown-item" href="#">
                          <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                              ...
                              <small class="text-muted">{{(Auth::User()->role_as ==1)? 'Admin' : 'User'}}</small>
                            </div>
                          </div>
                        </a>
                      </li>
